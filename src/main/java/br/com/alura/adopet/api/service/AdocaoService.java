...
import static br.com.alura.adopet.api.constants.MessagesConstants.*;
    ...
    public void reprovar(ReprovacaoDto dto) {
        ...
        emailService.enviarEmail(
                ...
                "Olá " +adocao.getTutor().getNome() +"!\n\nInfelizmente sua adoção do pet " +adocao.getPet().getNome() +", " +
                        "solicitada em " +adocao.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")) +", " +
                        "foi reprovada pelo abrigo " +adocao.getPet().getAbrigo().getNome() +" com a seguinte justificativa: " +adocao.getJustificativaStatus());
